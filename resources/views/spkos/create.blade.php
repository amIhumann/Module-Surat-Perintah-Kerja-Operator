          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">CREATE SPKO</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ route('spkos.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('employee') is-invalid @enderror" name="employee">
                            @foreach ($employees as $key => $value) 
                                <option {{ old('employee') == $value->id ? "selected" : "" }} value="{{ $value->id }}">{{ $value->nama }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control @error('trans_date') is-invalid @enderror" name="trans_date" value="{{ old('trans_date') }}" placeholder="Masukkan Serial No">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('process') is-invalid @enderror" name="process">
                            <option {{ old('process') == "Cor" ? "selected" : "" }} value="Cor">Cor</option>
                            <option {{ old('process') == "Brush" ? "selected" : "" }} value="Brush">Brush</option>
                            <option {{ old('process') == "Bombing" ? "selected" : "" }} value="Bombing">Bombing</option>
                            <option {{ old('process') == "Slep" ? "selected" : "" }} value="Slep">Slep</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('sw') is-invalid @enderror" name="sw" value="{{ old('sw') }}" placeholder="Masukkan Serial No">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('remarks') is-invalid @enderror" name="remarks" placeholder="Masukkan Catatan">{{ old('remarks') }}</textarea>
